...
model_names_dict = {  # assocating file naming with OPPOSITE model type
    "no_symm": rnn_model_hard_symm,
    "hard_symm": rnn_model_no_symm,
}
...
colours = ["C0", "C2", "C3"]
legend_dict = {
    "no_symm": "Sampling-only symmetry",
    "hard_symm": "Training-only symmetry",
}
...
plt.savefig("compare_results/all_compare/opposite_energy_vs_N_lr{0}.png".format(LR))

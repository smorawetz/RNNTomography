...
def run_training(data_name, num_spins, num_hidden, lr, num_epochs, optimizer):
    ...
    samples_path = "{0}/N{1}_{2}_samples.txt".format(data_folder, num_spins, data_name)
    state_path = "{0}/N{1}_{2}_groundstate.txt".format(
        data_folder, num_spins, data_name
    )
    energy_path = "{0}/N{1}_{2}_energy.txt".format(data_folder, num_spins, data_name)
